                    ...
                    <li>
                        <Link to="/leader" style={{ fill: "#B7B7B7" }}
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <polygon class="cls-1" points="89.66 155.06
                    ...
                    <li>
                        <Link to="/" style={{ fill: "#B7B7B7" }}
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <rect class="cls-1" x="21.22" y="93.38"
                                    width="71.31" height="95.08" rx="12" />
                                <ellipse class="cls-1" cx="109.93"
                                    cy="62.39" rx="26.74" ry="19.1" />
                                <rect class="cls-1" y="126.48"
                                    width="44.99" height="64.52" rx="12" />
                                <polygon class="cls-1" points="109.51 0
                    ...
                    <li>
                        <NavLink to="/profile"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <rect class="cls-1" x="28.75" y="74.09"
                                    width="62.49" height="91.95" rx="12" />
                                <circle class="cls-1" cx="60.44"
                                    cy="32.58" r="32.58" />
                                <rect class="cls-1" x="14.13" y="70.75"
                                    width="17.85" height="84.85" rx="8.87" transform="matrix(0.91, 0.42,
-0.42, 0.91, 49.82, 0.82)"/>
                                <rect class="cls-1" x="90.01" y="71.64"
                                    width="17.85" height="84.85" rx="8.87" transform="translate(236.71
175.85) rotate(155.09)"/>
                            </svg>
                        </NavLink>
                        <div className="dotNotification" id="redDot">
                        </div>
                    </li>
