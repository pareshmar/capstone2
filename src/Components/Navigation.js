            ...
            <div>
                <ul className="navigationBar">
                    ...
                    <li>
                        ...
                        <polygon class="cls-1" points="89.66 155.06 53.82 114.4 0 120.87 27.6 74.22 4.82 25.03 57.71 36.87 97.45 0 102.54 53.96 149.88 80.36 100.13 101.88 89.66 155.06"/>
                        </svg>
                        </Link>
                    </li>
                    <li>
                        <Link to ="/" style={{fill:"#B7B7B7"}} activeStyle={{fill: "#ffa500"}}>
                            ...
                            <rect class="cls-1" y="126.48" width="44.99" height="64.52" rx="12"/>
                            <polygon class="cls-1" points="109.51 0 97.62 189.3 128.27 189.3 109.51 0"/>
                            </svg>
                        </Link>
                    </li>
                    <li>
                        <NavLink to ="/categories" style={{fill:"#B7B7B7"}} activeStyle={{fill: "#fe4a49"}}>
                            <svg viewBox="0 0 186.76 139.72" className="categoriesIcon" id="test">
                                   
                                    <rect className="prefix__cls-1"  width={67} height={67} rx={12} />
                                    <rect
                                    ...
                                    <path
                                        className="prefix__cls-1"
                                        d="M108.9 105.84L81.42 89.3l26.93 48.67 78.41-99.47-77.86 67.34z"
                                    />
                            </svg>
                        </NavLink>
                    </li>
                    ...
                    <li>
                        <NavLink to ="/profile" style={{fill:"#B7B7B7"}} activeStyle={{fill: "#2ab7ca"}}>
                            <svg xmlns="http://www.w3.org/2000/svg" className="profileIcon" viewBox="0 0 121.98 166.04">
                            <rect class="cls-1" x="28.75" y="74.09" width="62.49" height="91.95" rx="12"/>
